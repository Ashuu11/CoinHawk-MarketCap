...
import ChcpriceConverter from '../../components/ChcpriceConverter'
...
const styles = {
    ...
    tabItem: `px-2`,
    tabContainer: `flex items-center p-2 rounded-xl bg-[#222531] border border-gray-500/10 text-sm ml-10`,
    info: `min-h-screen`,
